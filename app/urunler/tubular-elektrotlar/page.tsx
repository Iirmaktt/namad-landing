...
export default function TubularElektrotlarPage() {
  ...
  const electrodes = [
    {
      ...
      description: 'Elle kaynak için orta karbonlu toz dolgulu elektrot',
      hardness: '52-58 HRC',
      diameter: ['3.2mm', '4.0mm', '5.0mm'],
      applications: ['Manuel Onarım', 'Saha Uygulamaları', 'Küçük Parçalar'],
    ...
    },
    {
      ...
      description: 'Yüksek karbonlu elle kaynak elektrot',
      hardness: '58-62 HRC',
      diameter: ['3.2mm', '4.0mm', '5.0mm'],
      applications: ['Ağır Aşınma', 'Crusher Onarımı', 'Sert Yüzey Kaplama'],
      image: 'https://images.pexels.com/photos/1108572/pexels-photo-1108572.jpeg?auto=compress&cs=tinysrgb&w=400'
    },
    {
      slug: 'tubular-bnm',
      title: 'NAWEL Tubular BNM',
      standard: 'DIN 8555: MF 8-GF-58-G',
      description: 'Nikel-molibden takviyeli gelişmiş formülasyon',
      hardness: '55-60 HRC',
      diameter: ['3.2mm', '4.0mm'],
      applications: ['Korozif Ortam', 'Yüksek Sıcaklık', 'Kimyasal Endüstri'],
      image: 'https://images.pexels.com/photos/585418/pexels-photo-585418.jpeg?auto=compress&cs=tinysrgb&w=400'
    },
    {
      slug: 'tubular-nbs',
      title: 'NAWEL Tubular NBS',
      standard: 'DIN 8555: MF 7-GF-56-G',
      description: 'Nikel-bor-silisyum alaşımlı özel formülasyon',
      hardness: '54-59 HRC',
      diameter: ['3.2mm', '4.0mm', '5.0mm'],
      applications: ['Pompa Onarımı', 'Valve Seat', 'Wear Ring'],
      image: 'https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=400'
    },
    {
      slug: 'tubular-tic',
      title: 'NAWEL Tubular TiC',
      standard: 'DIN 8555: MF 9-GF-62-GTi',
      description: 'Titanyum karbür takviyeli maksimum sertlik',
      hardness: '60-65 HRC',
      diameter: ['3.2mm', '4.0mm'],
      applications: ['Ekstremal Aşınma', 'Cutting Tools', 'Wear Parts'],
  ...
  const filteredProducts = electrodes.filter(product =>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-4">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Toz Dolgulu El Elektrotları</span>
          </div>
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Toz Dolgulu El Elektrotları
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl">
            Elle kaynak uygulamaları için özel olarak formüle edilmiş, 
            yüksek performanslı toz dolgulu elektrot serisi
          </p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          <div className="flex-1">
            <div className="relative">
              ...
              <Input
                placeholder="Elektrot adı veya DIN kodu ile ara..."
                value={searchTerm}
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex space-x-2 pt-2">
                    <Button asChild size="sm" className="flex-1">
                      <Link href={`/urunler/tubular-elektrotlar/${product.slug}`}>
